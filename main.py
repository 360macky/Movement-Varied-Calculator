...
if missingData == 'd':
    ...
    if unknown == 'd':
        ...
        result = mv.not_final_velocity_find_initial_velocity(distance, acceleration, time)
        ...
        result = mv.not_final_velocity_find_time(distance, acceleration, initial_velocity)
